...
- **Walk-forward** (`walk_forward_adapter.run_honest_walk_forward` → `backtesting.run_retroactive_backtest`): validare Faza 1 (pool normal) chiar și la auto-invert; `progress_cb` + bară determinată; **depth = 30%** din istoric.
