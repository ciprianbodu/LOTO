...
- teste: 66 fisiere `test_*.py`, 1371 de teste (renumarat la 2026-09-26). Pe
  Python 3.14.7: 1351 trec, 20 sarite (integrarea reala a lansatorului, numai pe
...
- Butonul „🎟️ Bilet complet" din sidebar face cate un bilet fizic per joc din
  ...
  clasamentul metodei (`audit["timesfm_predictions"]`, prin `rank_by_score`,
  deci cu restrangerea bazei si penalizarea recenta deja aplicate): prea mic
  pentru variante distincte (6/49 cu pool 6) -> se adauga urmatorul numar din
  clasament; mai mare decat locurile de pe bilet (Joker peste 10) -> raman cele
  mai bine clasate numere. Fereastra spune ce s-a adaugat sau ce a ramas afara.
