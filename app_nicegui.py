...
_METHOD_DESC = {
    ...
    "prime_bias": "bias prime vs compuse + frecvență în clasă · number-theory",
    "649_volatility_low": "preferință pentru numere cu volatilitate joasă · math-649",
    "649_mod10_hot": "cifre finale (mod 10) recente fierbinți · math-649",
    "649_parity_recent": "trend par/impar pe fereastra recentă · math-649",
    "649_gmean_freq_rec": "medie geometrică frecvență + recency · math-649",
