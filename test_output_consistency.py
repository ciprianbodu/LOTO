...
def test_rendered_ranking_obeys_structural_gate_without_disqualifying_baseline(
    monkeypatch,
):
            ...
            [
                (
                    "joker.csv",
                    {
                        "joker": {
                            "pool_size": 10,
                            "audit": {"bench_winner": {"joker_urna1": info}},
                        }
                    },
                )
            ],
